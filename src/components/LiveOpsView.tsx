...
export const LiveOpsView: React.FC<LiveOpsViewProps> = ({
  ...
  return (
    <div id="live-ops-canvas" className="w-full max-w-3xl mx-auto p-4 sm:p-6 lg:p-8 space-y-6">
      {/* Top Header */}
      ...
      <section className="grid grid-cols-2 gap-3">
        <div
          id="stat-my-tasks"
          className="col-span-2 bg-white rounded-xl p-4 shadow-[0_4px_12px_rgba(0,0,0,0.03)] border border-[#E9ECEF] flex justify-between items-center"
        >
          <div>
            <h2 className="text-xs font-bold text-[#4e463a] uppercase tracking-wider">Active Tasks</h2>
            <p className="text-4xl font-bold text-[#765a25] mt-1">{pendingCount}</p>
          </div>
          <div className="h-12 w-12 rounded-full bg-[#bd9b60] flex items-center justify-center text-white shadow-xs">
        ...
        <div
          id="stat-urgent"
          className="bg-[#ffdad6] rounded-xl p-4 shadow-[0_4px_12px_rgba(0,0,0,0.03)] flex flex-col justify-between h-24"
        >
        ...
        <div
          id="stat-completed"
          className="bg-[#e6eff8] rounded-xl p-4 shadow-[0_4px_12px_rgba(0,0,0,0.03)] border border-[#E9ECEF] flex flex-col justify-between h-24"
        >
                ...
                >
                  ...
                  <div className="p-4 pl-5">
                    <div className="flex justify-between items-start mb-1.5">
                      ...
                      <span className={`text-xs font-semibold ${isHigh ? 'text-[#BC4749]' : 'text-[#4e463a]'}`}>
                        Due: {task.dueTime}
                      </span>
                    </div>

                    <p className="text-sm font-medium text-[#141d23] mb-1">{task.title}</p>
                    <p className="text-xs text-[#4e463a] mb-4">{task.description}</p>
